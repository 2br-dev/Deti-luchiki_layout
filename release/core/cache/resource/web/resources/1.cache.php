<?php  return array (
  ...
  array (
    ...
    'content' => '	<main id="main">
		<section id="hero">
			...
			<div class="container">
				<div class="hero-text">
					<h1>
						<span class="hide-xl-down">
							Центр поддержки семей, воспитывающих детей с особенностями в развитии «Дети-лучики»
						</span>
						<span class="hide-xl-up">
							Дети лучики
						</span>
					</h1>
					<p>
						<span class="hide-xl-down">
							Оказываем  социально-информационную и юридическо-правовую поддержку
						</span>
						<div class="hide-xl-up">
							Центр поддержки семей, воспитывающих детей с синдромом Дауна
						</div>
					</p>
					<a href="[[~2]]" class="btn">Узнать больше</a>
				</div>
				<div class="hero-image lazy" data-src="/img/hero_new1.png"></div>
			</div>
		</section>
		<section id="about">
			<div class="container shadowed">
				<div class="row flex vcenter">
					<div class="col s12">
						<h2>О синдроме</h2>
						<h3>Что такое синдром Дауна?</h3>
					</div>
					<div class="col l6 m12">
						<img src="" alt="" class="lazy about-image" data-src="/img/about.jpg">
					</div>
					<div class="col l6 m12">
						<p>
							Синдром Дауна - самая распространённая генетическая аномалия. По статистике, 
							каждый 700й-800й ребенок на планете появляется на свет с синдромом Дауна. 
							Это соотношение одинаково в разных странах, климатических зонах, социальных слоях. 
							Оно не зависит от образа жизни родителей, их здоровья, наличия или отсутствия 
							вредных привычек, цвета кожи, национальности. В нашей стране ежегодно рождается 
							около 2200 детей с синдромом Дауна. Мальчики и девочки с синдромом Дауна появляются 
							на свет с одинаковой частотой.
						</p>
					</div>
				</div>
				<div class="row flex points">
					<div class="col s12">
						<div class="divider"></div>
					</div>
					<div class="col xl2 l3 m6 s12 offset-xl2">
	<div class="point">
		<div class="point-icon">
			<img class="icon lazy" data-src="/img/points/point-icon-sun.svg">
		</div>
		<div class="point-wrapper">
			<div class="point-title">Солнечными</div>
			<div class="point-text">их называют за доброжелательность, открытость и наивность</div>
		</div>
	</div>
</div><div class="col xl2 l3 m6 s12 ">
	<div class="point">
		<div class="point-icon">
			<img class="icon lazy" data-src="/img/points/point-icon-virus.svg">
		</div>
		<div class="point-wrapper">
			<div class="point-title">Это не болезнь</div>
			<div class="point-text">Синдром Дауна нельзя вылечить или им заразиться, но можно помочь жить с ним.</div>
		</div>
	</div>
</div><div class="col xl2 l3 m6 s12 ">
	<div class="point">
		<div class="point-icon">
			<img class="icon lazy" data-src="/img/points/point-icon-award.svg">
		</div>
		<div class="point-wrapper">
			<div class="point-title">Могут добиваться</div>
			<div class="point-text">значительных успехов, и завоёвывать высокие награды в соревнованиях</div>
		</div>
	</div>
</div><div class="col xl2 l3 m6 s12 ">
	<div class="point">
		<div class="point-icon">
			<img class="icon lazy" data-src="/img/points/point-icon-dice.svg">
		</div>
		<div class="point-wrapper">
			<div class="point-title">Это может случится</div>
			<div class="point-text">с каждым – дети с синдромом Дауна могут появиться в любой семье</div>
		</div>
	</div>
</div>
					<div class="col s12">
		...
		<section id="projects">
			<div class="container">
				<div class="row">
					<div class="col s12"><h2>Наши проекты</h2></div>
					<div class="col l8 offset-l1 large">
						Наши проекты призваны улучшить качество жизни как маленьких ребят, так и взрослых людей с синдромом Дауна.
					</div>
					<div class="col l3"><a href="" class="btn">Заявка на участие</a></div>
				</div>
				<div class="row">
					<div class="col xl10 l11 m12 offset-xl2 offset-l1">
						<ul class="projects">
						    [[pdoResources?
						        &parents=`3`
						        &tpl=`project-main`
	...
	<div class="howto">
		<div class="title">Информационно-юридическая <br> поддержка</div>
		<div class="image lazy" data-src="/img/howto/1.jpg"></div>
	</div>
</div><div class="col l4 m6 s12">
	<div class="howto">
		<div class="title">Оказать материальную <br> поддержку</div>
		<div class="image lazy" data-src="/img/howto/2.jpg"></div>
	</div>
</div><div class="col l4 m6 offset-m3 s12">
	<div class="howto">
		<div class="title">Участвовать в качестве волонтёра или работодателя</div>
		<div class="image lazy" data-src="/img/howto/3.jpg"></div>
	</div>
</div>
				</div>
			</div>
		</section>
		<section id="consulting" class="padding">
			<div class="container">
				<div class="row">
					<div class="col s12">
						<div class="consulting-header">Получить консультацию для родителей</div>
					</div>
					...
					<div class="col l3 m6 s12">
						<div class="input-field select-field">
							<input type="hidden">
							<label for="" class="list-label">С чего начать?</label>
							<div class="indicator"></div>
							<ul>
								<li><a href="">С чего начать?</a></li>
								<li><a href="">Физиотерапия и оздоровление</a></li>
								<li><a href="">Социальная адаптация</a></li>
								<li><a href="">Клубы и кружки по интересам</a></li>
								<li><a href="">Муниципальные органы поддержки</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col s12 center-align"><a href="" class="btn">Отправить заявку</a></div>
				</div>
			</div>
		</section>
		<section id="news" class="padding">
			<div class="container">
				...
				<div class="row flex" id="top">
					[[pdoResources?
					    &parents=`7`
					    &tpl=`news-recent`
					    &limit=`4`
					    &includeTVs=`image,date`
					    &includeContent=`1`
					    &showUnpublished=`1`
					]]
				</div>
				<div class="row flex" id="rest">
				    [[pdoResources?
				        &parents=`7`
				        &tpl=`news-rest`
				        &limit=`6`
				...
				<div class="row">
					<div class="col s12 center-align"><a href="[[~7]]" class="btn">Смотреть все</a></div>
				</div>
			</div>
		</section>
	</main>',
...
<title>Официальный сайт проекта Дети-лучики – Главная</title>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col xl10 l11 m12 offset-xl2 offset-l1">
						<ul class="projects">
						    <li class="project">
	<a href="about/projects/early-help.html">
		<h3>Ранняя помощь</h3>
		<span class="lazy" data-src="/img/projects/5_big.jpg"></span>
	</a>
</li>
<li class="project">
	<a href="about/projects/social-events.html">
		<h3>Социо-культурные мероприятия</h3>
		<span class="lazy" data-src="/img/projects/6_big.jpg"></span>
	</a>
</li>
<li class="project">
	<a href="about/projects/adaptation-center.html">
		<h3>Центр адаптации и развития</h3>
		<span class="lazy" data-src="/img/projects/4_big.jpg"></span>
	</a>
</li>
<li class="project">
	<a href="about/projects/resource-center.html">
		<h3>Ресурсный центр</h3>
		<span class="lazy" data-src="/img/projects/2_big.jpg"></span>
	</a>
</li>
<li class="project">
	<a href="about/projects/mental-development.html">
		<h3>Духовно-нравственное развитие</h3>
		<span class="lazy" data-src="/img/projects/3_big.jpg"></span>
	</a>
</li>
<li class="project">
	<a href="about/projects/dancing-rays.html">
		<h3>Танцующие лучики</h3>
		<span class="lazy" data-src="/img/projects/1_big.jpg"></span>
	</a>
</li>
						</ul>
					</div>
	...
	<div class="image lazy h" data-src="img/news/24-09-2021.jpg"></div>
	<div class="date">2021-09-24 12:29:00</div>
	<h3 class="title">Поездка в Свято-Михайло-Афонский монастырь</h3>
	<div class="intro">В рамках Программы духовно-нравственного воспитания детей с ОВЗ наши дети не только системно занимаются развитием творчества, музыкой и изучают малую родину на занятиях Кубановедения, но и регулярно…</div>
</div>
<div class="col xl3 l6 s12">
	<div class="image lazy h" data-src="img/news/24-08-2021.jpg"></div>
	<div class="date">2021-08-24 12:28:00</div>
	<h3 class="title">Психологические тренинги для родителей детей с синдромом Дауна</h3>
	<div class="intro">В нашем Центре регулярно проходят психологические тренинги для родителей детей с синдромом Дауна. Посещение тренингов позволяет родителям (опекунам) детей с синдромом Дауна изменить отношение к свои…</div>
</div>
<div class="col xl3 l6 s12">
	<div class="image lazy h" data-src="img/news/19-08-2021.jpg"></div>
	<div class="date">2021-08-19 12:38:00</div>
	<h3 class="title">Выставки краснодарских музеев</h3>
	<div class="intro">Группы наших детей регулярно посещают выставки краснодарских музеев. Музей имени Коваленко, музей имени Фелицына уже приняли наших ребят. Посещения проходят в рамках Программы духовно-нравственного…</div>
</div>
<div class="col xl3 l6 s12">
	<div class="image lazy h" data-src="img/news/10-08-2021.jpg"></div>
	<div class="date">2021-08-10 12:20:00</div>
	<h3 class="title">Региональный конкурс творческих работ «Ты – Кубань, ты – наша Родина!»</h3>
	<div class="intro">Стартовал прием заявок на Регионального конкурса творческих работ «Ты – Кубань, ты – наша Родина!», который пройдет с 20 августа по 15 сентября, среди детей с синдромом Дауна по трем возрастным…</div>
</div>
				</div>
				<div class="row flex" id="rest">
				    <div class="col xl4 l6 s12">
	<div class="news-entry">
		<div class="image lazy h" data-src="img/news/28-07-2021.jpg"></div>
		<div class="text">
			<h3 class="title">Занятия творчеством для родителей детей с синдромом Дауна</h3>
			<div class="date">2021-07-28 12:15:00</div>
		</div>
	</div>
</div>
<div class="col xl4 l6 s12">
	<div class="news-entry">
		<div class="image lazy h" data-src="img/news/21-07-2021.jpg"></div>
		<div class="text">
			<h3 class="title">Занятия музыкой, ИЗО, кубановедения</h3>
			<div class="date">2021-07-21 12:13:00</div>
		</div>
	</div>
</div>
<div class="col xl4 l6 s12">
	<div class="news-entry">
		<div class="image lazy h" data-src="img/news/27-06-2021.jpg"></div>
		<div class="text">
			<h3 class="title">Обучение основам фотографии для родителей</h3>
			<div class="date">2021-06-27 12:12:00</div>
		</div>
	</div>
</div>
<div class="col xl4 l6 s12">
	<div class="news-entry">
		<div class="image lazy h" data-src="img/news/25-06-2021.jpg"></div>
		<div class="text">
			<h3 class="title">Программа духовно-нравственного воспитания детей с особенностями в развитии</h3>
			<div class="date">2021-06-25 12:10:00</div>
		</div>
	</div>
</div>
<div class="col xl4 l6 s12">
	<div class="news-entry">
		<div class="image lazy h" data-src="/img/news/12-06-2021.jpg"></div>
		<div class="text">
			<h3 class="title">Посещение конной фермы во Владимирке</h3>
			<div class="date">2021-06-12 12:07:00</div>
		</div>
	</div>
</div>
<div class="col xl4 l6 s12">
	<div class="news-entry">
		<div class="image lazy h" data-src="img/news/01-06-2021.jpg"></div>
		<div class="text">
			<h3 class="title">Картина «Дерево дружбы»</h3>
			<div class="date">2021-06-01 12:05:00</div>
		</div>
	</div>
</div>
				</div>
				<div class="row">
					<div class="col s12 center-align"><a href="about/news/" class="btn">Смотреть все</a></div>
				</div>
			</div>
		</section>
	</main>
