  ...
  array (
    ...
    <section id="content">
        <div class="container shadowed">
            <div class="row flex">
                <div class="col s12">
                    <h2>Адреса, телефоны</h2>
                    <h3>Краснодар</h3>
                </div>
                <div class="col l4 m12 s12 order-m1">
                    <hr class="small">
                    <ul class="addresses">
                        <li>
                            <a data-anchor="krasnodar" href="#krasnodar" class="address">Краснодар</a>
                        </li>
                        <li>
                            <a data-anchor="novorossiysk" href="#novorossiysk" class="address">Новороссийск</a>
                        </li>
                        <li>
                            <a data-anchor="tuapse" href="#tuapse" class="address">Туапсе</a>
                        </li>
                    </ul>
                    <div id="krasnodar" class="address-content active">
                        kras
                        <p>
                            Руководитель, председатель правления<br>
                            Начарова Александра Сергеевна<br>
                            тел. 8 (905) 408-57-54
                        </p>
                        <p>
                            Отдел бухгалтерии<br>
                            Кузнецова Галина Александровна<br>
                            тел. 8 (928) 432-91-97
                        </p>
                        <p>
                            Куратор проекта «Танцующие лучики»<br>
                            Широбокова Юлия Владимировна<br>
                            тел. 8 (903) 453-19-19
                        </p>
                        <p>Новороссийск</p>
                        <p>
                            Руководитель филиала<br>
                            Коваленко Анна Николаевна<br>
                            тел. 8 (918) 452-23-23
                        </p>
                    </div>
                    <div id="novorossiysk" class="address-content">
                        novoros
                        <p>
                            Руководитель, председатель правления<br>
                            Начарова Александра Сергеевна<br>
                    ...
                    <div id="tuapse" class="address-content">
                        tuapse
                        <p>
                            Руководитель, председатель правления<br>
                            Начарова Александра Сергеевна<br>
                ...
                <div class="col l8 m12 s12">
                    <div class="map-wrapper">
                        <ul class="map-markers">
                            <li><a data-anchor="all" class="address active" href="#krasnodar">Все филиалы</a></li>
                            <li><a data-anchor="krasnodar" class="address" href="#krasnodar">Краснодар</a></li>
                            <li><a data-anchor="novorossiysk" class="address" href="#novorossiysk">Новороссийск</a></li>
                            <li><a data-anchor="tuapse" class="address" href="#tuapse">Туапсе</a></li>
                        </ul>
                        <div id="map"></div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col xl8 offset-xl2 l10 offset-l1 m12">
                    <h3 class="center-align">Реквизиты</h3>
                    <div class="kv-table">
                        <div class="kv-row">
                            <div class="key">Наименование:</div>
                            <div class="value">ККОО ЦПСВДОР «ДЕТИ ЛУЧИКИ»</div>
                        </div>
                        <div class="kv-row">
                            <div class="key">Индивидуальный Номер Налогоплательщика (ИНН)</div>
                            <div class="value">2309152877</div>
                        </div>
                        <div class="kv-row">
                            <div class="key">Код Причины Постановки на учёт (КПП)</div>
                            <div class="value">230901001</div>
                        </div>
                        <div class="kv-row">
                            <div class="key">Юридический адрес</div>
                            <div class="value">350007, г. Краснодар, ул. А. Матросова, д. 99</div>
                        </div>
                        <div class="kv-row">
                            <div class="key">Фактический адрес</div>
                            <div class="value">г. Краснодар, ул.Щорса, д.7/3</div>
                        </div>
                        <div class="kv-row">
                            <div class="key">Расчётный счёт</div>
                            <div class="value">40703810830000001427</div>
                        </div>
                        <div class="kv-row">
                            <div class="key">Корреспондентский счёт</div>
                            <div class="value">30101810100000000602</div>
                        </div>
                        <div class="kv-row">
                            <div class="key">Банк, отделение</div>
                            <div class="value">Краснодарское отделение №8619 ПАО Сбербанк</div>
                        </div>
                        <div class="kv-row">
                            <div class="key">Банковский идентификационный код (БИК)</div>
                            <div class="value">040349602</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1647515733,
    'editedby' => 1,
    'editedon' => 1649157966,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1647515700,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<title>Официальный сайт проекта Дети-лучики – Контакты</title>
...
<body>
	...
	<div class="row">
		...
		<div class="col l6 offset-l1 m8 s12">
			<p>Если у Вас родился ребенок с синдромом Дауна и Вы не знаете куда идти и что делать,если Вам кажется, что мир рухнул - не отчаивайтесь, мы рядом!</p>
		</div>
	</div>
