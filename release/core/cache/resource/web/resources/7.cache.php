<?php  return array (
  ...
  array (
	    ...
	    <div class="container">
	        ...
	        <div class="row flex" id="rest">
	           [[!pdoPage?
	               ...
	               &tpl=`news-rest`
	               &includeTVs=`image,date`
	               &tplPageWrapper=`paginationWrapper`
	               &tplPageActive=`paginationActive`
	               &tplPage=`paginationPage`
	               &showUnpublished=`1`
	           ]]
	        </div>
	        <div class="row">
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1647515315,
    'editedby' => 1,
    'editedon' => 1648100963,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1647515280,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<title>Официальный сайт проекта Дети-лучики – Новости</title>
...
<body>
	...
	<h1>Новости</h1>
	<p>В рамках Программы духовно-нравственного воспитания детей с ОВЗ наши дети не только системно занимаются развитием творчества, музыкой и изучают малую родину на занятиях Кубановедения, но и регулярно…</p>
</div>
<div class="col xl4 offset-xl2 l4 offset-l2 s12">
    <div class="news-last lazy h round" data-src="img/news/24-09-2021.jpg"></div>
</div>
        		<div class="circle-red large" id="red1"></div>
                <div class="circle-red small" id="red2"></div>
                <div class="circle-red small" id="red3"></div>
...
<div class="col xl4 offset-xl2 l4 offset-l2 s12">
    ...
    '[[pdoResources?tpl=`news-rest`&returnIds=``&showLog=``&fastMode=``&sortby=`publishedon`&sortbyTV=``&sortbyTVType=``&sortdir=`DESC`&sortdirTV=`ASC`&limit=`12`&offset=`5`&depth=`10`&outputSeparator=`
`&toPlaceholder=``&parents=`7`&includeContent=``&includeTVs=`image,date`&prepareTVs=`1`&processTVs=``&tvPrefix=`tv.`&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=``&showUnpublished=`1`&showDeleted=``&showHidden=`1`&hideContainers=``&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`page.total`&resources=``&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``&plPrefix=``&maxLimit=`100`&page=`1`&pageVarKey=`page`&pageLimit=`5`&element=`pdoResources`&pageNavVar=`page.nav`&pageCountVar=`pageCount`&pageLinkScheme=``&tplPage=`paginationPage`&tplPageWrapper=`paginationWrapper`&tplPageActive=`paginationActive`&tplPageFirst=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[%pdopage_first]]</a></li>`&tplPageLast=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[%pdopage_last]]</a></li>`&tplPagePrev=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">&laquo;</a></li>`&tplPageNext=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">&raquo;</a></li>`&tplPageSkip=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">...</a></li>`&tplPageFirstEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">[[%pdopage_first]]</a></li>`&tplPageLastEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">[[%pdopage_last]]</a></li>`&tplPagePrevEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">&laquo;</a></li>`&tplPageNextEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">&raquo;</a></li>`&cache=``&cacheTime=`3600`&cacheAnonymous=``&ajax=``&ajaxMode=``&ajaxElemWrapper=`#pdopage`&ajaxElemRows=`#pdopage .rows`&ajaxElemPagination=`#pdopage .pagination`&ajaxElemLink=`#pdopage .pagination a`&ajaxElemMore=`#pdopage .btn-more`&ajaxTplMore=`@INLINE <button class="btn btn-primary btn-more">[[%pdopage_more]]</button>`&ajaxHistory=``&setMeta=`1`&strictMode=`1`&request=`157a448b7fba7dccb303404bec0987a6`&setTotal=`1`]]' => '<div class="col xl4 l6 s12">
...
<div class="col xl4 l6 s12">
	<div class="news-entry">
		<div class="image lazy h" data-src="img/news/21-05-2021.jpg"></div>
		<div class="text">
			<h3 class="title">Инклюзивный праздник «Город дружбы»</h3>
			<div class="date">2021-05-21 12:04:00</div>
		</div>
	</div>
</div>
<div class="col xl4 l6 s12">
	<div class="news-entry">
		<div class="image lazy h" data-src="img/news/09-05-2021.jpg"></div>
		<div class="text">
			<h3 class="title">День Победы в войне с фашистскими захватчиками</h3>
			<div class="date">2021-05-09 12:01:00</div>
		</div>
	</div>
</div>
<div class="col xl4 l6 s12">
	<div class="news-entry">
		<div class="image lazy h" data-src="img/news/29-04-2021.jpg"></div>
		<div class="text">
			<h3 class="title">Ресурсный Центр для родителей детей с синдромом Дауна</h3>
			<div class="date">2021-04-29 12:00:00</div>
		</div>
	</div>
</div>
<div class="col xl4 l6 s12">
	<div class="news-entry">
		<div class="image lazy h" data-src="img/news/21-03-2021.jpg"></div>
		<div class="text">
			<h3 class="title">Международный день человека с синдромом Дауна</h3>
			<div class="date">2021-03-21 11:58:00</div>
		</div>
	</div>
</div>
<div class="col xl4 l6 s12">
	<div class="news-entry">
		<div class="image lazy h" data-src="img/news/8-03-2021.jpg"></div>
		<div class="text">
			<h3 class="title">С праздником весны! С 8 марта!</h3>
			<div class="date">2021-03-08 11:56:00</div>
		</div>
	</div>
</div>
<div class="col xl4 l6 s12">
	<div class="news-entry">
		<div class="image lazy h" data-src="img/news/30-01-2021.jpg"></div>
		<div class="text">
			<h3 class="title">Стартовал проект «Ресурсный центр»</h3>
			<div class="date">2021-03-01 11:53:00</div>
		</div>
	</div>
</div>
<div class="col xl4 l6 s12">
	<div class="news-entry">
		<div class="image lazy h" data-src="img/news/28-02-2021.jpg"></div>
		<div class="text">
			<h3 class="title">Школа моделей</h3>
			<div class="date">2021-02-28 11:51:00</div>
		</div>
	</div>
</div>',
  ),
