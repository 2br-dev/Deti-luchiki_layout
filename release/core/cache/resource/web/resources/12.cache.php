<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<main id="psychological-help">
        ...
        <div class="container shadowed">
            <div class="row flex vcenter">
                <div class="col l6 m8 s12">
                    <div class="lazy h" data-src="/img/psychological-help.jpg"></div>
                </div>
                <div class="col xl4 offset-xl1 l6 m12">
                    <p>
                        Вокруг синдрома много стереотипов, мешающих трезво оценить ситуацию, принять правильное решение и принять своего ребенка, каким бы он ни был. 
                        Родителям приходится пережить очень сложные чувства, адаптироваться к новой жизненной ситуации, перестроить планы, реорганизовать свою жизнь, 
                        найти для ребенка подходящий ему способ обучения и развития. Но в результате родители и ребенок смогут прийти к взаимопониманию, опровергнуть многие предрассудки, 
                        получать радость от общения.
                    </p>
                    <p>
                        Это бывает непросто, поэтому в нашем центре есть психолог, который поможет вам пройти этот путь, а также открыт ресурсный центр для поддержки родителей и помощи им в трудоустройстве.
                    </p>
                </div>
            </div>
            <div class="row">
                [[$small-hr]]
                <div class="col xl6 offset-xl3 m8 offset-m2 s12 align-center-m-up">
                    <p>
                        Помощь психолога и арт-терапевта помогает повысить образованность родителей в вопросе воспитания и абилитации их «солнечных» детей, улучшить психологическое состояние в семье, 
                        понять чувства и переживания друг друга, восстановить эмоциональное состояние, личностные ресурсы, найти в себе силы для продолжения активной социальной жизни. 
                    </p>
                    <p>
                        Главная цель нашего ресурсного центра – улучшения качества жизни семьи в целом и родителей в частности.
                    </p>
                </div>
            </div>
        </div>
...
<title>Официальный сайт проекта Дети-лучики – Помощь психолога</title>
...
<body>
    ...
    <main id="psychological-help">
    <section id="small-hero">
        <div class="container">
	<div class="row">
		<div class="col offset-l1 l11 m12">
			<h1>Помощь психолога</h1>
		</div>
		<div class="col l6 offset-l1 m8 s12">
			<p>Принятие ребёнка с синдромом бывает непростым. Это длительный путь со своими трудностями и препятствиями. И это нормально!</p>
		</div>
	</div>
