        ...
        <div class="container shadowed">
            <div class="row flex vcenter">
                <div class="col xl5 l5 m6 s12">
                    <div class="lazy h" data-src="/img/about-syndrome-title.jpg"></div>
                </div>
                <div class="col xl4 l5 m6 s12 offset-xl1 offset-l1">
                    <p>
                        Синдром Дауна – это самая распространённая генетическая патология. Это не болезнь. Синдром нельзя вылечить, с ним не нужно бороться, и самое главное: 
                        вы не виноваты, что у вашего ребёнка синдром Дауна. Любите и поддерживайте его таким, какой он есть. 
                    </p>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row flex">
                <div class="col l2 m4 s8">
                    <div class="lazy q" data-src=""></div>
                </div>
                <div class="col l4 m8 s12 valign-wrapper">
                    <p class="valign">
                        Синдром Дауна возникает, когда у человека есть полная или частичная дополнительная копия хромосомы 21-й пары.
                    </p>
                </div>
                <div class="col l2 m4 s8">
                    <div class="lazy q" data-src=""></div>
                ...
                <div class="col l4 m8 s12 valign-wrapper">
                    <p class="valign">
                        Существует три типа синдрома Дауна: трисомия 21 составляет 95% случаев, на транслокацию приходится около 4%, а на мозаичность — около 1%. 
                    </p>
                </div>
                <div class="col l2 m4 s8">
                    <div class="lazy q" data-src=""></div>
                ...
                <div class="col l4 m8 s12 valign-wrapper">
                    <p class="valign">
                        Синдром Дауна одна из наиболее часто встречающихся хромосомных болезней. Диагностируют примерно у каждого из 700 новорожденных детей в Соединенных Штатах. Это около 6 000 человек в год.
                    </p>
                </div>
                <div class="col l2 m4 s8">
                    <div class="lazy q" data-src=""></div>
                ...
                <div class="col l4 m8 s12 valign-wrapper">
                    <p class="valign">
                        Синдром Дауна может быть  у людей всех рас и любого финансового состояния.
                    </p>
                </div>
                <div class="col l2 m4 s8">
                    <div class="lazy q" data-src=""></div>
                ...
                <div class="col l4 m8 s12 valign-wrapper">
                    <p class="valign">
                        Чем старше женщина, тем больше вероятность, что у нее родится «солнечный» ребенок. Но 80% детей с синдромом Дауна рождаются у мам в возрасте до 35 лет. Обусловлено это высокой рождаемостью у молодых женщин.
                    </p>
                </div>
                <div class="col l2 m4 s8">
                    <div class="lazy q" data-src=""></div>
                ...
                <div class="col l4 m8 s12 valign-wrapper">
                    <p class="valign">
                        Люди с синдромом Дауна имеют повышенный риск для определенных заболеваний: врожденный порок сердца, проблемы с дыханием и слухом, болезнь Альцгеймера, детский лейкоз и болезни щитовидной железы. Многие из этих недугов поддаются лечению, поэтому большинство людей с синдромом Дауна живут полноценной жизнью.
                    </p>
                </div>
            </div>
        </div>
...
<title>Официальный сайт проекта Дети-лучики – О синдроме</title>
...
<body>
	...
	<div class="row">
		...
		<div class="col l6 offset-l1 m8 s12">
			<p>Некоторые факты о синдроме Дауна</p>
		</div>
	</div>
