  ...
  array (
    ...
    <section id="content">
        <div class="container shadowed">
            <div class="row xl-offset">
                <div class="col s12">
                    <h2 class="center-align">Часто задаваемые вопросы</h2>
                    [[pdoResources?
                        &tpl=`question`
                        &includeContent=`1`
                    ]]
            ...
            <div class="row">
                <div class="col xl8 offset-xl2 l10 offset-l1 m12 s12 center-align">
                    <h2>Всё ещё остались вопросы?</h2>
                    <p>
                        Если Вы не нашли ответа на интересующий Вас вопрос, <a href="#contact-form" class="modal-trigger">напишите нам</a>, и мы постараемся ответить на Ваш вопрос, а в случае его актуальности для широкого круга пользователей, 
                        мы включим его в нашу секцию часто задаваемых вопросов.
                    </p>
                </div>
            </div>
        </div>
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1647515429,
    'editedby' => 1,
    'editedon' => 1648025479,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1647515400,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<title>Официальный сайт проекта Дети-лучики – F.A.Q.</title>
...
<body>
	...
	<div class="row">
		...
		<div class="col l6 offset-l1 m8 s12">
			<p>Часто задаваемые вопросы на актуальные темы</p>
		</div>
	</div>
    ...
    <div class="header-wrapper">
        <div class="header">
            <h3 class="open-answer">Что такое синдром Дауна?</h3>
        </div>
        <a href="" class="close-answer"><i class="mdi mdi-plus"></i></a>
    </div>
    <div class="answer">
        Синдром Дауна – это генетическая аномалия, вызванная трисомией 21 пары хромосом. В подавляющем большинстве случаев, около 97-98% – это является случайным, непредсказуемым нарушением в двадцать первой паре хромосом. 
Исключением могут быть некоторые случаи транслокационной формы, когда один из родителей является носителем сбалансированной транслокации.
    </div>
</div>
<div class="question-wrapper">
    <div class="header-wrapper">
        <div class="header">
            <h3 class="open-answer">Могут ли проблемы во время беременности вызвать это нарушение?</h3>
        </div>
        <a href="" class="close-answer"><i class="mdi mdi-plus"></i></a>
    </div>
    <div class="answer">
...
<div class="question-wrapper">
    <div class="header-wrapper">
        <div class="header">
            <h3 class="open-answer">Чем отличается синдром Дауна от болезни Дауна?</h3>
        </div>
        <a href="" class="close-answer"><i class="mdi mdi-plus"></i></a>
    </div>
    <div class="answer">
        Ничем. Болезнь Дауна – это устаревшее название. По последней международной классификации болезней (МКБ) следует называть «синдром Дауна». Изменение формулировки связано с тем, что называть синдром болезнью некорректно: 
синдром Дауна невозможно приобрести при жизни и его невозможно вылечить.
    </div>
</div>
<div class="question-wrapper">
    <div class="header-wrapper">
        <div class="header">
            <h3 class="open-answer">Диагноз моему ребенку поставили только по внешнему виду, как узнать правильный ли он? Какие анализы сдавать?</h3>
        </div>
        <a href="" class="close-answer"><i class="mdi mdi-plus"></i></a>
    </div>
    <div class="answer">
...
<div class="question-wrapper">
    <div class="header-wrapper">
        <div class="header">
            <h3 class="open-answer">Есть ли опасность, что у моих будущих детей будет синдром Дауна? Может ли у меня родиться здоровый ребенок?</h3>
        </div>
        <a href="" class="close-answer"><i class="mdi mdi-plus"></i></a>
    </div>
    <div class="answer">
        В случае наличия у ребенка стандартной или мозаичной формы трисомии риск рождения ребенка с синдромом Дауна крайне мал. Но в России рождение ребенка с хромосомной патологией, является показанием 
для проведения инвазивной пренатальной диагностики с определением кариотипа плода при последующих беременностях. Если у ребенка транслокационная форма синдрома Дауна, при планировании последующей 
беременности родителям рекомендуется сдать анализы на кариотип, чтобы выяснить, является ли кто-нибудь из них носителем сбалансированной транслокации.
    </div>
</div>
<div class="question-wrapper">
    <div class="header-wrapper">
        <div class="header">
            <h3 class="open-answer">Какие формы синдрома Дауна бывают?</h3>
        </div>
        <a href="" class="close-answer"><i class="mdi mdi-plus"></i></a>
    </div>
    <div class="answer">
        Существуют несколько трисомий по 21 паре: стандартная трисомия, транслокационная форма и мозаичная форма синдрома Дауна. Наиболее часто встречающаяся форма – это стандартная трисомия по 21 паре. 
Кариотип ребенка с этой формой трисомии будет обозначен как 47ХХ+21 (если это девочка) и 47ХУ+21 (если это мальчик) Около 95% детей с синдромом Дауна рождаются с этой формой трисомии.
    </div>
</div>
<div class="question-wrapper">
    <div class="header-wrapper">
        <div class="header">
            <h3 class="open-answer">Что такое транслокационная форма синдрома Дауна? В чем ее особенности?</h3>
        </div>
        <a href="" class="close-answer"><i class="mdi mdi-plus"></i></a>
    </div>
    <div class="answer">
...
Примерно три четверти случаев транслокационной формы происходят случайно, как и стандартная трисомия, однако бывают случаи, когда один из родителей является носителем сбалансированной транслокации. Поэтому, если 
у ребенка анализ показал транслокационную форму трисомии, родителям, перед рождением следующего ребенка, стоит пройти генетическое обследование.
    </div>
</div>
<div class="question-wrapper">
    <div class="header-wrapper">
        <div class="header">
            <h3 class="open-answer">Как наличие мозаичной формы синдрома Дауна сказывается на развитии ребенка?</h3>
        </div>
        <a href="" class="close-answer"><i class="mdi mdi-plus"></i></a>
    </div>
    <div class="answer">
...
Считается, что дети с мозаичной формой синдрома более развиты интеллектуально, но точных данных, позволяющих уверенно об этом говорить, не существует.
    </div>
</div>
<div class="question-wrapper">
    <div class="header-wrapper">
        <div class="header">
            <h3 class="open-answer">Какие обследования нужно пройти в первые месяцы жизни, каких врачей посетить?</h3>
        </div>
        <a href="" class="close-answer"><i class="mdi mdi-plus"></i></a>
    </div>
    <div class="answer">
        Ваш основной  врач - педиатр, а не невролог, или генетик, как это часто думают. Педиатр, наблюдающий вашего ребенка, его осматривает, дает направления на ОАК (общий анализ крови), анализы мочи и далее все, что полагается делать каждому ребенку. 
Кроме педиатра, ребенка должны осмотреть:
<ul class="browser-default">
    <li>Кардиолог (ЭКГ, ЭхоЭГ) на первом месяце, далее по показаниям</li>
    <li>Обследовать функцию щитовидной железы (эндокринолог: ТТГ, Т3, Т4 – в роддоме, далее 1 раз в год) </li>
    <li>Проверка зрения - окулист (рефрактометрия) - в возрасте 1, 3 и 6 лет </li>
    <li>Неврологическая консультация – невролог в возрасте 1, 3 и 12 месяцев. Далее не реже 1 раза в год </li>
    <li>Ортопедическая консультация – ортопед (по необходимости, узи, рентген) в возрасте 3, 6 и 12 месяцев </li>
    <li>Проверка слуха  – сурдолог, физиолог слуха (тимпанометрия, аудиометрия) в возрасте 6-9 месяцев, далее – по необходимости</li>
    <li>Отоларинголог – осмотр в возрасте 3, 6 и 12 месяцев</li>
</ul>
...
<div class="question-wrapper">
    <div class="header-wrapper">
        <div class="header">
            <h3 class="open-answer">Может ли мой ребенок находиться на грудном вскармливании?</h3>
        </div>
        <a href="" class="close-answer"><i class="mdi mdi-plus"></i></a>
    </div>
    <div class="answer">
