<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Ресурсный центр',
    'longtitle' => 'для родителей, воспитывающих детей с синдромом Дауна',
    'description' => '',
    'alias' => 'resource-center',
    'alias_visible' => 1,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<main id="project">
	<section id="small-hero">
	    [[$small-hero]]
	</section>
	<section id="content">
		<div class="container">
			<div class="row flex vcenter xl-offset">
				<div class="col xl5 offset-xl1 l6 m12">
					<div class="lazy h" data-src="/img/projects/2_big.jpg"></div>
				</div>
				<div class="col xl4 offset-xl1 l6 m12">
					<p>
					    Помощь нужна не только детям, но и их родителям. Существует много мифов о синдроме. 
					    Часто родители не знают, что делать, и кто им может помочь. Поддержать родителей, 
					    успокоить их и научить жить в новых условиях – наша главная задача в рамках Ресурсного 
					    центра для родителей, воспитывающих детей с синдромом Дауна. Проект реализуется 
					    при финансовой поддержке Фонда президентских грантов по двум направлениям
					</p>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col l6 m12">
					<div class="lazy wide" data-src="/img/psychological-care.jpg"></div>
					<h2>Психолого-педагогическая поддержка.</h2>
					<p>
						Помощь психолога и арт-терапевта в данном направлении помогает повысить образованность 
						родителей в вопросе воспитания и абилитации их «солнечных» детей, улучшить психологическое 
						состояние в семье, понять чувства и переживания друг друга, восстановить эмоциональное состояние, 
						личностные ресурсы, найти в себе силы для продолжения активной социальной жизни.
					</p>
				</div>
				<div class="col l6 m12">
					<div class="lazy wide" data-src="/img/coworking.jpg"></div>
					<h2>Помощь в трудоустройстве</h2>
					<p>
						Мы не просто помогаем с трудоустройством, а проводим целый комплекс мероприятий, направленных 
						на улучшение финансового состояния семей, предоставления места для работы (коворкинг) с организацией 
						присмотра за детьми, переподготовкой по специальностям, позволяющим работать удаленно и с гибким графиком, 
						профориентацией и развитием профессиональных и надпрофессиональных навыков.
					</p>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col xl6 offset-xl3 l8 offset-l2 m12 align-center-l-up"> 
					<p>
					    Ресурсный центр помогает родителям справиться с воспитанием ребенка с синдромом Дауна, мобилизовать 
					    их ресурсы для решения задач реабилитационного процесса, даст возможность работать и учиться в коворкинге, 
					    предоставит свободное время для решения вопросов по здоровью и быту семьи и продолжения активной социальной жизни, 
					    укрепит материальное положение семьи.
					</p>
					<p>
						Мы создаём среду поддерживающего окружения с целью улучшения качества жизни семьи в целом.
					</p>
				</div>
			</div>
		</div>
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1647516797,
    'editedby' => 1,
    'editedon' => 1647856593,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1647516780,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'about/projects/resource-center.html',
    'uri_override' => 0,
...
<title>Официальный сайт проекта Дети-лучики – Ресурсный центр</title>
...
<body>
	...
	<div class="row">
		<div class="col offset-l1 l11 m12">
			<h1>Ресурсный центр</h1>
		</div>
		<div class="col l6 offset-l1 m8 s12">
			<p>для родителей, воспитывающих детей с синдромом Дауна</p>
		</div>
	</div>
