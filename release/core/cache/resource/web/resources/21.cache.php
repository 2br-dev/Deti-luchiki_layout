<?php  return array (
  ...
  array (
    ...
    'longtitle' => 'Поддержка и участие неравнодушных людей – то, что позволяет нам работать, каждый день помогая людям. Здесь мы расскажем как можете помочь в нашей работе вы.',
    'description' => '',
    'alias' => 'participate',
    'alias_visible' => 1,
    'link_attributes' => '',
        ...
        <div class="container shadowed">
            <div class="row flex">
                <div class="col l6 m12 s12">
                    <div class="row">
                        <div class="col xl10 m8 l12">
                            <div class="lazy h" data-src="/img/give-a-money.jpg"></div>
                        </div>
                    </div>
                    <div class="col xl10 l12 offset-xl2">
                        <h2>Материальная поддержка</h2>
                        <p>Оплатить работу педагогов – деньги. Купить детям игрушки – деньги. Сделать тысячу других полезных вещей также стоит денег.</p>
                        <p>Мы – некоммерческий центр помощи. Брать деньги с людей, которые попали в сложную жизненную ситуацию неправильно, поэтому работа центра полностью зависит от тех, кто в состоянии оказать эту помощь.</p>
                        <p>Каждое пожертвование – возможность. Уникальная возможность помогать людям день ото дня. И мы будем рады, если благодаря вам мы сможем стабильно работать и дальше.</p>
                        <p>Каждое пожертвование фиксируется, каждая трата записывается, а все отчёты о нашей деятельности есть в открытом доступе на нашем сайте. Вы можете их изучить и принять своё собственное решение о помощи.</p>
                        <a href="" class="btn">Пожертвовать<i class="mdi mdi-launch"></i></a>
                    </div>
                </div>
                <div class="col l6 m12 s12">
                    <div class="row">
                        <div class="col xl10 m8 l12">
                            <div class="lazy h" data-src="/img/volunters.jpg"></div>
                        </div>
                    </div>
                    <div class="col xl10 l12 offset-xl2">
                        <h2>Волонтёрство</h2>
                        <p>Мы всегда что-то делаем: учим детей, проводим тренинги для родителей, участвуем или организуем выездные мероприятия. Это всегда непростая задача, требующая вовлечения многих-многих людей. </p>
                        <p>
                            У нас всегда есть чем заняться, но часто не хватает тех, кто готов этим заниматься. Став волонтёром, вы способны не только существенно облегчить нам жизнь, но и получить новый, интересный опыт, 
                            обрести неожиданных друзей и чуть лучше узнать как живут дети с синдромом Дауна и их родителя.
                        </p>
                        <p>Ваш труд неоценим, и мы будем очень рады видеть вас в рядах волонтёров!</p>
                        <a href="#request" 
                            class="btn modal-trigger"
                            data-sections="i-want|participate&&participation-type|as"
                            data-inputs="iwant1|radio|checked&&type2|radio|checked&&profession|hidden|Волонтёра"
                            >
                            Оставить заявку
                        </a>
                    </div>
                ...
                <div class="col l6 m12 s12">
                    <div class="row">
                        <div class="col xl10 m8 l12">
                            <div class="lazy h" data-src="/img/help-to-parents.jpg"></div>
                        </div>
                    </div>
                    <div class="col xl10 l12 offset-xl2">
                        <h2>Работа для родителей</h2>
                        <p>
                            Синдром Дауна – не приговор и не конец света, но часто конец трудовой карьеры для родителя/родителей. Особенным детям нужно больше любви, внимания и терпения, чтобы они не отставали от своих сверстников, 
                            поэтому практически всё время, особенно на ранних этапах, уходит на заботу о ребёнке.
                        </p>
                        <p>
                            Но мир не стоит на месте. Сейчас у работодателей есть возможность устраивать людей на удалённую работу, дать им возможность зарабатывать из дома, работать не 8 часов, а чуть меньше.
                        </p>
                        <p>
                            Для родителей – это спасение. Они готовы трудится в поте лица, отдаваясь работе с головой, учиться новому лишь за возможность зарабатывать деньги на уход и воспитание ребенка честным трудом.
                        </p>
                        <p>
                            Дайте родителям шанс. Особенно, если у вас есть для этого возможности. Они в долгу не останутся.
                        </p>
                        <a href="#request" 
                            class="btn modal-trigger"
                            data-sections="i-want|get-support"
                            data-inputs="iwant2|radio|checked&&comment|text|Я хотел бы получить новую профессию ()"
                            >
                            Оставить заявку
                        </a>
                    </div>
                ...
                <div class="col l6 m12 s12">
                    <div class="row">
                        <div class="col xl10 m8 l12">
                            <div class="lazy h" data-src="/img/give-a-job.jpg"></div>
                        </div>
                    </div>
                    <div class="col xl10 l12 offset-xl2">
                        <h2>Помощь с трудоустройством</h2>
                        <p>
                            Дети с синдромом Дауна совершенно не такие, как многие привыкли рисовать их в своем воображении. Да, очень многие бытовые задачи даются им с трудом, но они полны энергии, 
                            заряжены и готовы постоянно учиться.
                        </p>
                        <p>
                            Вы можете помочь им и для этого нужно совсем немного: дать им шанс поработать. Если у вас есть такая возможность. Естественно, мы не говорим о полноценной занятости, но работа 
                            на полставки, практика, небольшая стажировка совершенно точно не повредит вам, но зато сильно вдохновит ребят расти и самосовершенствоваться.
                        </p>
                        <a href="#request" 
                            class="btn modal-trigger"
                            data-sections="i-want|participate&&participation-type|as"
                            data-inputs="iwant1|radio|checked&&type2|radio|checked&&profession|hidden|Работодателя"
                            >
                            Оставить заявку
                        </a>
                    </div>
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1647515794,
    'editedby' => 1,
    'editedon' => 1649148995,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1647515760,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<title>Официальный сайт проекта Дети-лучики – Хочу помочь</title>
...
<body>
	...
	<div class="row">
		...
		<div class="col l6 offset-l1 m8 s12">
			<p>Поддержка и участие неравнодушных людей – то, что позволяет нам работать, каждый день помогая людям. Здесь мы расскажем как можете помочь в нашей работе вы.</p>
		</div>
	</div>
