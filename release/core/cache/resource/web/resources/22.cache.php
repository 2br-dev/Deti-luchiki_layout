<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Танцующие лучики',
    'longtitle' => 'Для танцев не существует преград',
    'description' => '',
    'alias' => 'dancing-rays',
    'alias_visible' => 1,
    'link_attributes' => '',
	...
	<section id="content">
		<div class="container shadowed">
			<div class="row flex vcenter">
				<div class="col xl5 offset-xl1 l6 m8 s12 xl-offset">
					<div class="lazy h" data-src="/img/projects/1_big.jpg"></div>
				</div>
				<div class="col xl4 offset-xl1 l6 m12">
					<p>
					    Танцевать может каждый. «Танцующие Лучики» ярчайший тому пример. Проект успешно работает с 2017 года 
					    и за это время «Танцующие лучики» успели стать лауреатами призерами Международного фестиваля-конкурса 
					    «Полифония сердец. Радуга талантов», международного арт фестиваля «Вдохновение», всероссийского фестиваля 
					    «Добрая волна», межрегионального фестиваля «Inclusive Dance Sochi», Всероссийском конкурсе «Inclusive Dance. 
					    Большой кубок» и др.
					</p>
				</div>
			</div>
			<div class="row flex vcenter xl-offset">
				<div class="col xl5 offset-xl1 l6 m12">
			        <p>
				        «Танцующие Лучики» направлены на обучение детей искусству танца. Мы выбрали танец в качестве творческой активности 
				        неспроста: давно известно, что Танец - это процесс, при котором наши движения совпадают с сопровождающей музыкой, 
				        что говорит о его прямой связи с нашим восприятием. 
				    </p>
				    <p>
				        В танце хореограф помогает детям с синдромом Дауна развить самоосознание, избавиться от эмоциональных зажимов, 
				        развить способность контроля своего тела и нахождения альтернативных моделей поведения, открыть более ясное 
				        восприятие себя и других. Вызвать такие перемены в поведении человека, которые будут предвещать более здоровое 
				        функционирование детей.
				    </p>
				</div>
				<div class="col xl5 offset-xl1 l6 m8 s12 order-m1">
					<div class="lazy h" data-src="/img/dancing2.jpg"></div>
				</div>
			</div>
		</div>
	</section>
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1647516763,
    'editedby' => 1,
    'editedon' => 1647869681,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1647516720,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'about/projects/dancing-rays.html',
    'uri_override' => 0,
...
<title>Официальный сайт проекта Дети-лучики – Танцующие лучики</title>
...
<body>
	...
	<div class="row">
		<div class="col offset-l1 l11 m12">
			<h1>Танцующие лучики</h1>
		</div>
		<div class="col l6 offset-l1 m8 s12">
			<p>Для танцев не существует преград</p>
		</div>
	</div>
